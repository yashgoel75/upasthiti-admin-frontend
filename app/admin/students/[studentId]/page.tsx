...
import { ArrowLeft, Phone, Mail, BookOpen, Hash, IdCard, Building2, Landmark } from "lucide-react";
...
export default function SingleStudent() {
  ...
  if (loading) {
    return (
      <div
        className={`min-h-screen flex items-center justify-center ${theme === "dark" ? "bg-gray-900 text-gray-300" : "bg-gray-50"
          }`}
      >
